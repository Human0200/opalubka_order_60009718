...
<thead><tr><td colspan="2"><h2 class="h4"><?echo GetMessage("subscr_title_settings")?></h2></td></tr></thead>
<tr valign="top">
	<td class="left_blocks">
		...
		<h3 class="h5"><?echo GetMessage("subscr_rub")?><span class="star">*</span></h3/>
		...
		<h3 class="h5"><?echo GetMessage("subscr_fmt")?></h3>
