...
<?if($arResult['ITEMS']):?>
	<?
	$col = !empty($arParams['SIZE_IN_ROW']) ? (round(12/$arParams['SIZE_IN_ROW'])) : 4;
	...
	<div class="content_wrapper_block <?=$templateName;?> <?=$bType2 ? 'text-inside' : ''?>">
		<div class="maxwidth-theme">
			<div class="item-views float_banners <?=$arParams['TYPE_BLOCK'];?><?=($arResult['MIXED_BLOCKS'] && $bType2 ? ' sm-block' : '');?>">
				<div class="items">
					<div class="row flexbox justify-center swipeignore  mobile-margin-16 mobile-compact c_<?=count($arResult['ITEMS'])?>">
