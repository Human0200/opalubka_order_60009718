...
<?if($arResult['ITEMS']):?>
	...
	<div class="content_wrapper_block <?=$templateName;?>">
		<div class="">
			<div class="item-views 2 float_banners2 swipeignore <?=($arResult['MIXED_BLOCKS'] ? ' sm-block' : '');?> <?=$arParams['BG_BLOCK_POSITION'];?> <?=$bOnlyOne ? 'one-item' : ''?> owl-carousel owl-theme owl-bg-nav short-nav hidden-dots visible-nav swipeignore wsmooth1 appear-block loading_state" data-plugin-options='{"nav": true, "dots": false, "loop": false, "marginMove": false, "autoplay": false, "smartSpeed": 600, "useCSS": false, "responsive": {"0":{"loop": true, "autoplay": true, "items": 1, "autoWidth": false, "lightDrag": false, "margin":10}, "601":{"items": 2, "autoWidth": false, "lightDrag": false, "margin":10},"1100":{"items": 2, "margin":10}, "1200":{"items": 3, "margin":10}}}'>
									...
									<div class="inner-text<?=(!$bType2 ? '' : ' text-center');?> flexbox">
										...
										<?if($arItem['PREVIEW_TEXT'] && !$bTopBgBlock):?>
											<div class="previewtext font_xs muted777">
												...
												<?if ($arItem['ID']==86):?>
												Выгодная стоимость за счет двух производственных баз и трех складов, расположенных вблизи Москвы.
												<?else:?>
												<?=$arItem['PREVIEW_TEXT'];?>
												<?endif;?>
											</div>
