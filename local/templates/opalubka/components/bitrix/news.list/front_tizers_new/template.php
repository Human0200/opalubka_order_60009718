									...
									<div class="inner-text">
										<?/*<div class="title <?=($bSmallBlock ? 'font_xs' : 'font_md');?>">
											<?if($bDetailLink):?>
												<a href="<?=$arItem['PROPERTIES']['LINK']['VALUE']?>">
											<?endif;?>
											<span <?=($bSmallBlock ? 'class="muted777"' : '');?> ><?=$arItem['~NAME'];?> <?=$arItem['FIELDS']['PREVIEW_TEXT']?></span>
											<?if($bDetailLink):?>
												</a>
											<?endif;?>
										</div>*/?>
										...
										<?if(isset($arItem['FIELDS']['PREVIEW_TEXT']) && strlen($arItem['FIELDS']['PREVIEW_TEXT']) && !$bSmallBlock):?>
											<div class="value font_xs muted777"><?=$arItem['~NAME'];?> <?//=$arItem['FIELDS']['PREVIEW_TEXT']?></div>
										<?endif;?>
									</div>
								</div>
							</div>
