											...
											<div class="wrap  rounded3 box-shadow clearfix" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
												...
												<?if($bShowMessButton):?>
													<div class="send_message_button">
														<span class="btn btn-default btn-xs" data-event="jqm" data-param-form_id="ASK_STAFF" data-autoload-staff="<?=CMax::formatJsName($arItem['NAME'])?>" data-name="ask_staff"><?=(strlen($arParams['SEND_MESSAGE_BUTTON_TEXT']) ? $arParams['SEND_MESSAGE_BUTTON_TEXT'] : Loc::getMessage('SEND_MESSAGE_BUTTON_TEXT'))?></span>
													</div>
												<?endif?>
