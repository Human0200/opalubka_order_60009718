...
<?if($arResult['ITEMS']):?>
	...
	<div class="maxwidth-theme only-on-front">
		...
		<div class="item-views collection <?=$arParams['VIEW_TYPE']?>">
			<div class="items flexbox row<?=($arParams['NO_MARGIN']!='Y' && $arParams['VIEW_TYPE'] == 'grey_pict' ? ' margin-10' : '');?> <?=($arParams['NO_MARGIN']=='Y') ? ' margin0 ' : '';?> <?=($bSlider ? ' swipeignore  mobile-margin-16 mobile-compact' : '');?> c_<?=count($arResult['ITEMS']);?>">
		<?endif?>
		<?global $arTheme;
