								...
								<div class="text">
									...
									<?else:?>
										...
										<?if($arResult['PREVIEW_TEXT']):?>
											...
											<div class="preview-text muted777"><div class="h3">
												 "Астория СЛК"
											</div>
											 <br>
											<p>
												 Мы являемся производителем: стеновой опалубки, объемной опалубки, двухтавровой балки и комплектующих.
											</p>
											<ul>
											<li>3 склада в Москве;</li>
											<li>Быстрая доставка;</li>
											<li>Повседневная тарификация;</li>
											<li>Рассрочка и лизинг;</li>
											<li>Арендный парк более 150.000 м2;</li>
											</ul>
											<div class="form_footer">
											 <button type="submit" class="btn btn-default has-ripple" value="submit" name="web_form_submit" data-event="jqm" data-param-form_id="CALLBACK" data-name="CALLBACK">Заказать звонок</button>
														</div></div>
