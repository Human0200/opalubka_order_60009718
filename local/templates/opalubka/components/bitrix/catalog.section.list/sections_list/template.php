							...
							<td class="section_info toggle">
								<ul>
									<li class="name<?=($bBigBlock ? ' text-center' : '');?>">
                                        ...
                                        <?$minSectionPrice = getSectionMinPrice($arItems['ID']);?>
                                        <?if(!empty($minSectionPrice)){?>
                                            <div class="section_item-min-price">
                                                <span>Цена от <?=$minSectionPrice?>/шт</span>
                                            </div>
                                        <?}?>
										<div class="dop_op"><?=$arItems["~UF_ADDESC"] ///var_dump($arItems) ?></div>
                                        <div class="zak">
											<a class="zaklink" href="#" data-event="jqm" data-param-id="19" data-name="callback"><button class="btnzak">Заказать</button></a>
											<?=$arItems["~UF_ANONS"] ?>
										</div>
									</li>
									<?if($arItems["SECTIONS"]):?>
...
<div class="r_links">
	<a href="#x" class="overlay" id="win4"></a>
									    <div class="popup" style=" width: 400px; z-index:  999999;top: 357px;
    left: 47%;">
...
<style type="text/css">
	#win4 a.jqmClose {display: none !important;}
</style>