...
$sectAdv = CIBlockSection::GetList(
        [], 
        ["IBLOCK_ID"=>$arResult["IBLOCK_ID"], "ID"=> $arResult["SECTION"]["ID"]], 
        false, ["UF_ADV"], 
        false)->GetNext()["~UF_ADV"];
					...
					<div class="flexbox flexbox--row align-items-center justify-content-between flex-wrap">
						...
						<div class="col-auto">
							<div class="product-info-headnote__inner">
								...
								<?}else{?>
                                    <meta itemprop="brand" content="Астория-СЛК" />
                                <?}?>
							</div>
						</div>
					</div>
								...
								<?$frame = $this->createFrame()->begin('');?>
									<div class="">
										...
										<div class="prices_block">
											<?//prices?>
											<div class="cost prices detail"><div class="priceFrom price font-bold font_mxs">от </div>
												<?if($arResult["OFFERS"]):?>
...
$arTextParams = [
    'name' => $arResult['NAME'],
    'width' => $arResult['PROPERTIES']['PROP_SHIRSHITNEW']['VALUE'] ?: '--',
    'deflection' => $arResult['PROPERTIES']['PROP_PROGIB']['VALUE'] ?: '--',
    'thick' => $arResult['PROPERTIES']['PROP_TOLSHPROFILE']['VALUE'] ?: '--',
    'weight' => $arResult['PROPERTIES']['PROP_159']['VALUE'] ?: '--',
    'price' => $arResult['MIN_PRICE']['VALUE'],
];
?>

<?$this->SetViewTarget('PRODUCT_PREVIEW_TEXT_INFO');?>
    <div class="content detail-text-wrap preview-text" itemprop="description">
<div>
    <?=$arResult['~DETAIL_TEXT']?>
</div>
        <?
        if ($arResult['IBLOCK_ID'] == 21) {
            $APPLICATION->IncludeFile(SITE_DIR."include/custom/product_preview_text_1.php", $arTextParams, []);
        } elseif ($arResult['IBLOCK_ID'] == 36) {
            $APPLICATION->IncludeFile(SITE_DIR."include/custom/product_preview_text_2.php", $arTextParams, []);
        }
        ?>
    </div>
<?$this->EndViewTarget();?>
...
<?$this->SetViewTarget('PRODUCT_DETAIL_TEXT_INFO');?>
    <div class="content detail-text-wrap detail-text">
        <?
        if ($arResult['IBLOCK_ID'] == 21) {
            $APPLICATION->IncludeFile(SITE_DIR."include/custom/product_detail_text_1.php", $arTextParams, []);
        } elseif ($arResult['IBLOCK_ID'] == 36) {
            $APPLICATION->IncludeFile(SITE_DIR."include/custom/product_detail_text_2.php", $arTextParams, []);
        }
        ?>
    </div>
<?$this->EndViewTarget();?>
...
<?$this->SetViewTarget('PRODUCT_SERTIFY_INFO');?>
    <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/sertify_block.php", array(), array());?>
<?$this->EndViewTarget();?>

<?$this->SetViewTarget('PRODUCT_GOSTS_INFO');?>
<?$APPLICATION->IncludeFile(SITE_DIR."include/custom/gosts_block.php", array(), array());?>
<?$this->EndViewTarget();?>

<?$this->SetViewTarget('PRODUCT_ADDR_STORE_INFO');?>
    <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/catalog_map_block.php", array(), array());?>
<?$this->EndViewTarget();?>

<?$this->SetViewTarget('PRODUCT_CALL_INFO');?>
    <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/catalog_call_block.php", array(), array());?>
<?$this->EndViewTarget();?>

<?$this->SetViewTarget('PRODUCT_OPAL_ADV_INFO');?>
    <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/opal_adv_block.php", array(), array());?>
<?$this->EndViewTarget();?>
