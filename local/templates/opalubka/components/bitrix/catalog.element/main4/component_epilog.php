...
<?/* if (!empty($templateData['SECTION_ADV'])) { 
    echo $templateData['SECTION_ADV'];
} */?>

<? if ($arResult["ID"]): ?>
    <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/tizers_block.php", array(), array());?>
            ...
            <? endforeach; ?>
                ...
                <? if ($i > 1): ?>
                            ...
                            <? if ($bShowDetailTextTab || ($arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB" && $bShowPropsTab)): ?>
                                        ...
                                        <? if ($value == "serts"): ?>
                                            <li class="bordered rounded3 <?= (!($iTab++) ? 'active' : '') ?>">
                                                <a href="#sert" data-toggle="tab">
                                                    <?= ($arParams["T_SERT"] ? $arParams["T_SERT"] : "Сертификаты"); ?>
                                                </a>
                                            </li>
                                            <? endif; ?>
                                            <? if ($value == "gosts"): ?>
                                            <li class="bordered rounded3 <?= (!($iTab++) ? 'active' : '') ?>">
                                                <a href="#gosts" data-toggle="tab">
                                                    <?= ($arParams["T_GOSTS"] ? $arParams["T_GOSTS"] : "ГОСТы"); ?>
                                                </a>
                                            </li>
                                            <? endif; ?>
                                            <? //show char block?>
                            ...
                            <? if ($bShowDeliveryTab): ?>
                                                    ...
                                                    <li class="bordered rounded3 <?= (!($iTab++) ? 'active' : '') ?>">
                                                        <a href="#addr_store" data-toggle="tab">
                                                        <?= ($arParams["T_ADDR_STORE"] ? $arParams["T_ADDR_STORE"] : "Адреса складов"); ?>
                                                        </a>
                                                    </li>
                                                    <li class="bordered rounded3 <?= (!($iTab++) ? 'active' : '') ?>">
                                                        <a href="#call" data-toggle="tab">
                                                        <?= ($arParams["T_CALL"] ? $arParams["T_CALL"] : "Связаться с нами"); ?>
                                                        </a>
                                                    </li>
                                                <? endif; ?>
                                            <? endif; ?>
                    ...
                    <? endforeach; ?>
                            ...
                            <div class="tab-content<?= ($i <= 1 ? ' not_tabs' : '') ?>">
                                ...
                                <? foreach ($arTabOrder as $value): ?>
                                    <? //detail text?>
                                    <? if ($value == "desc"): ?>
                        <? if ($bShowDetailTextTab || ($arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB")): ?>
                                            <div class="tab-pane <?= (!($iTab++) ? 'active' : '') ?>" id="desc">
                                                <? $APPLICATION->ShowViewContent('PRODUCT_PREVIEW_TEXT_INFO') ?>
                            ...
                            <? endif; ?>
                                            ...
                                            <div class="tab-pane <?= (!($iTab++) ? 'active' : '') ?>" id="sert">
                                            <? $APPLICATION->ShowViewContent('PRODUCT_SERTIFY_INFO') ?>
                                            </div>
                                            <div class="tab-pane <?= (!($iTab++) ? 'active' : '') ?>" id="gosts">
                                                <? $APPLICATION->ShowViewContent('PRODUCT_GOSTS_INFO') ?>
                                            </div>
                                        <? endif; ?>
                                    <? endif; ?>
                                    <? //props?>
                                    ...
                                    <? if ($value == "delivery"): ?>
                                            ...
                                            <div class="tab-pane <?= (!($iTab++) ? 'active' : '') ?>" id="addr_store">
                                                <? $APPLICATION->ShowViewContent('PRODUCT_ADDR_STORE_INFO') ?>
                                            </div>
                                            <div class="tab-pane <?= (!($iTab++) ? 'active' : '') ?>" id="call">
                                                <? $APPLICATION->ShowViewContent('PRODUCT_CALL_INFO') ?>
                                            </div>
                                        <? endif; ?>
                                    <? endif; ?>
                                    <? //custom_tab?>
    ...
    <? //feedback ?>
        ...
        <? endif; ?>
        <? $APPLICATION->ShowViewContent('PRODUCT_OPAL_ADV_INFO') ?>
...
<? else: ?>
        ...
        <? if ($_GET["RID"]) { ?><script>$(document).ready(function () {
