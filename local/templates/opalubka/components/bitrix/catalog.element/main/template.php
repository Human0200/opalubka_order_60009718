...
<ul id="bx_117848907_949_prop_405_list" class="list_values_wrapper">

<?php //var_dump($arResult['PROPERTIES']['ASSOCIATED']['VALUE']);

   $res2 = CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID" => 21, "ID"=> $arResult['PROPERTIES']['ASSOCIATED']['VALUE']), Array("ID","DETAIL_PAGE_URL","PROPERTY_PROP_DLINOPALSHIT"));
	while($ar_fields1 = $res2->GetNext())
		{
		//	var_dump($ar_fields1);
		?>
 <li class="item " data-treevalue="405_189" data-showtype="li" data-onevalue="189" title="Вес: 5 кг"><a href="<?=$ar_fields1["DETAIL_PAGE_URL"]?>"><i></i><span class="cnt"><?=$ar_fields1["PROPERTY_PROP_DLINOPALSHIT_VALUE"]?> кг</span></a></li>
			<?php
}
?>
</ul>
...
<div class="sku_props">
<div class="bx_item_detail_size">
	<h3 style="font-size: 11px; margin-top: 10px;">Другие размеры:</h3>
<ul id="bx_117848907_949_prop_405_list" class="list_values_wrapper" style="margin">
...
$el_res= CIBlockElement::GetByID($ar_fields1["ID"]);
 $el_arr= $el_res->GetNext();
		?>
 <li class="item " ><a href="<?=$el_arr['DETAIL_PAGE_URL']?>"><i></i><span class="cnt"><?=$ar_fields1["PROPERTY_PROP_DLINOPALSHIT_VALUE"]?> м</span></a></li>
			<?php
}
?>
</ul>
       ...
       <!-- <div class="counter_wrapp list clearfix">
									<div class="counter_block_inner">
												<div class="counter_block md" data-item="950">
							<span class="minus dark-color" id="bx_quant_down"><i class="svg inline  svg-inline-wish ncolor colored1" aria-hidden="true"><svg width="11" height="1" viewBox="0 0 11 1"><rect width="11" height="1" rx="0.5" ry="0.5"></rect></svg></i></span>
							<input type="text" class="text" id="days" name="days" value="1">
							<span class="plus dark-color" id="bx_quant_up"><i class="svg inline  svg-inline-wish ncolor colored1" aria-hidden="true"><svg width="11" height="11" viewBox="0 0 11 11"><path d="M1034.5,193H1030v4.5a0.5,0.5,0,0,1-1,0V193h-4.5a0.5,0.5,0,0,1,0-1h4.5v-4.5a0.5,0.5,0,0,1,1,0V192h4.5A0.5,0.5,0,0,1,1034.5,193Z" transform="translate(-1024 -187)"></path></svg></i></span>
						</div>
													</div>
												</div>-->
									<h4>Срок аренды</h4>
								<div class="counter_block1 md">
									<span class="minus dark-color" id="bx_quant_down"><i class="svg inline  svg-inline-wish ncolor colored1" aria-hidden="true"><svg width="11" height="1" viewBox="0 0 11 1"><rect width="11" height="1" rx="0.5" ry="0.5"></rect></svg></i></span>
									<input type="text" class="text" id="days" name="days" value="1">
									<span class="plus dark-color" id="bx_quant_up"><i class="svg inline  svg-inline-wish ncolor colored1" aria-hidden="true"><svg width="11" height="11" viewBox="0 0 11 11"><path d="M1034.5,193H1030v4.5a0.5,0.5,0,0,1-1,0V193h-4.5a0.5,0.5,0,0,1,0-1h4.5v-4.5a0.5,0.5,0,0,1,1,0V192h4.5A0.5,0.5,0,0,1,1034.5,193Z" transform="translate(-1024 -187)"></path></svg></i></span>
								</div>
								<script type="text/javascript">
							document.cookie = "days=1;  expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/; SameSite=None; Secure";
							//sessionStorage.setItem('days', '11111');
							$("#bx_quant_down").click(function(){
								srok=parseInt($('#days').val(),10);
								    if(srok>-1){
									$('#days').val(parseInt($('#days').val(),10)-1);
								 document.cookie = "days="+$('#days').val()+";  expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/; SameSite=None; Secure";
								}

									});

							$("#bx_quant_up").click(function(){
									$('#days').val(parseInt($('#days').val(),10)+1);
									 document.cookie = "days="+$('#days').val()+";  expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/; SameSite=None; Secure";
									});
									...
									$( "#days" ).change(function() {
									    document.cookie = "days="+$('#days').val()+";  expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/; SameSite=None; Secure";
											/*sessionStorage.setItem('days', $('#days').val());*/
											});
								</script>
								<style type="text/css">
							      	.counter_block1{
									...
									.counter_block1>span:not(:hover) .svg {
									    opacity: .5;
									}
							      	.counter_block1 .minus {
									  left: 10px;
									  width: 30px;
									}
									.counter_block1 .minus, .counter_block1 .plus {
										  top: 0;
										  bottom: 0;
										  height: auto;
										  cursor: pointer;
									...
									.counter_block1 input[type=text] {
    width: 47px;
    border: 0;
    background: 0 0;
