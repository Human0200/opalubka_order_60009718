...
<?if( $arResult["ITEMS"] && count( $arResult["ITEMS"] ) >= 1 ){?>
    ...
    <div class="table-view-outer <?=($bShowOfferTree ? ' table-view-offer-tree' : '');?> <?=($bColProps ? ' table-view-outer--hidden' : '');?>" >
        <?if($bOptBuy && $arParams["AJAX_REQUEST"] != "Y"):?>
	...
	"offers": {
		...
		"itemCondition": "https://schema.org/NewCondition"
                    ...
                    <div class="table-view__item-wrapper item_info catalog-adaptive flexbox flexbox--row">
                        ...
                        <?//image-block?>
                        <div class="item-foto">
                            <div class="item-foto__picture js-notice-block__image d-none d-md-block">
                                <?\Aspro\Functions\CAsproMaxItem::showImg($arParams, $arItem, !$bComplect);?>
                            </div>
                            <div class="d-block d-md-none owl-carousel owl-theme owl-bg-nav short-nav hidden-dots visible-nav swipeignore wsmooth1 appear-block loading_state" data-plugin-options='{"nav": false, "dots": true, "loop": false, "marginMove": false, "autoplay": false, "smartSpeed": 600, "useCSS": false, "items": 1, "autoWidth": false, "lightDrag": false, "margin":10}'>
                                        ...
                                        <div class="properties js-offers-prop">
                                            <?if ($boolShowProductProps):?>
                                                <?foreach ($arItem['DISPLAY_PROPERTIES'] as $arProp):?>
                                                    <div class="properties-table-item d-flex js-prop-replace">
														<span class="properties__title font_sxs muted js-prop-title">
															<?=$arProp['NAME']?>:&nbsp;&nbsp;
															<b><?if(is_array($arProp["DISPLAY_VALUE"]) && count($arProp["DISPLAY_VALUE"]) > 1):?>
                                            ...
                                            <?if ($arItem["OFFERS"][$arItem["OFFERS_SELECTED"]]['DISPLAY_PROPERTIES']):?>
                                                <?foreach ($arItem["OFFERS"][$arItem["OFFERS_SELECTED"]]['DISPLAY_PROPERTIES'] as $arProp):?>
                                                    <div class="properties-table-item d-flex js-prop">
														<span class="properties__title font_sxs muted">
															<?=$arProp['NAME']?>:&nbsp;&nbsp;
														</span>
                                                        <span class="properties__value darken font_sm">
...
<?endif;?>
    ...
    <div class="wrap_nav bottom_nav_wrapper">
        ...
        <div class="bottom_nav <?=$arParams["DISPLAY_TYPE"];?>" <?=($showAllCount ? 'data-all_count="'.$allCount.'"' : '')?> <?=($arParams["AJAX_REQUEST"]=="Y" || $_REQUEST["AJAX_REQUEST"] == "Y"  ? "style='display: none; '" : "");?>>
