...
<input type="hidden" name="recaptcha_token" value="">
			...
			<button type="submit" class="btn btn-lg btn-default" onclick="this.form.recaptcha_token.value = window.recaptcha.getToken()"><span><?=$arResult["arForm"]["BUTTON"]?></span></button>
