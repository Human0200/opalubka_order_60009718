...
<div class="form inline <?=$arResult["arForm"]["SID"]?>">
	...
	<div class="form_head">
		<?if($arResult["isFormTitle"] == "Y"):?>
			<h2 style="text-align:center;margin:20px 0; color:#000">Оформить заказ</h2>
		<?endif;?>
...
<input type="hidden" name="recaptcha_token" value="">
			...
			<button type="submit" class="btn btn-default" value="submit" onclick="this.form.recaptcha_token.value = window.recaptcha.getToken()"><span><?=$arResult["arForm"]["BUTTON"]?></span></button>
