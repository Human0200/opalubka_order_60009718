...
<div class="sect_inf" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
						...
						<div class="sect_pic">
								<img src="<?=CFile::GetPath($section["UF_TOPPIC"])?>">
						</div>
						<?=$section["UF_TECH"] ?>
								...
								<a href="#x" class="overlay" id="win1"></a>
									...
									<a href="#x" class="overlay" id="win4"></a>
									    <div class="popup" style=" width: 900px; z-index:  999999;top: 357px;
    left: 457px;">
     .<?$APPLICATION->IncludeComponent(
...
<?if($itemsCnt):?>
	...
	<?}?>
	<div class="2 right_block1 clearfix catalog1 <?=strtolower($arTheme["FILTER_VIEW"]["VALUE"]);?>" id="right_block_ajax">
