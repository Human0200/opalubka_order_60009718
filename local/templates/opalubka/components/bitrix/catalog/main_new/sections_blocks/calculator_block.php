<div class="catalog-content-block">
    <h3>
        <?
$text='<div class="seopodmena">Калькулятор {{text_tip_roditpadej}}</div>';
...
?>
    ...
    <div class="outwrapper">
        ...
        <div class="wrapper">
            ...
            <div class="inwrapper">
                <span>1</span> <input class="r2" type="range" min="10" max="30" id="r2"><span
                    class="middle-span">2</span><span>3</span>
            </div>
        </div>
...
<script type="text/javascript"
    src="https://cdnjs.cloudflare.com/ajax/libs/rangeslider.js/2.3.0/rangeslider.min.js"></script>
<script type="text/javascript">
...
Калькулятор {{text_tip_roditpadej}} от "Астория СЛК" предназначен для упрощения процесса планирования строительства. Он позволяет пользователям быстро и точно рассчитать необходимое количество опалубочных элементов для их проектов. Вводя параметры своего строительного объекта, клиенты могут получить оценку необходимого количества опалубки. Этот инструмент особенно полезен для строителей и архитекторов, поскольку он помогает минимизировать расходы и избегать перерасхода материалов, а также повышает эффективность планирования.
</div>';
zamena_arenda(21,$arResult['VARIABLES']['SECTION_ID'],$text);
?>
