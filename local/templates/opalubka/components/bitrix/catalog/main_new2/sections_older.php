...
<div class="main-catalog-wrapper">
	<div class="section-content-wrapper <?=($bShowLeftBlock ? 'with-leftblock' : '');?>">
		...
		<link href="/local/templates/opalubka/components/bitrix/catalog/main_new/new.css"  rel="stylesheet" />
		...
		<!--Блок 1 начало-->
			...
			<!--Блок 7 начало-->
			<div class="newblock7">
				<? $APPLICATION->IncludeFile(SITE_DIR . "include/custom/objects_block.php", Array(), Array("MODE" => "html", "NAME" => "Текст блока 7",)); ?>
			</div>
			<!--Блок 7 конец-->
			...
			<div class="newblock8">
				...
				<div  class="drag-block container FLOAT_BANNERS " data-class="float_banners_drag" data-order="4">
					<?=CMax::ShowPageType('mainpage', 'float_banners', 'type_2');?>
				</div>
			...
			<div class="newblock11">
				<div align="center">
				<div class="cta1">
					<img src="/banner-4-new.png" class="cta1img"> <a href="#" data-event="jqm" data-param-id="19" data-name="callback" class="link1"></a> <a href="https://wa.me/74951910920" class="link2"></a> <a href="https://t.me/+74951910920" class="link3"></a>
					</div>
				</div>
			</div>
			<!--Блок 11 конец-->
	...
	"AREA_FILE_SHOW" => "file",	// Показывать включаемую область
		...
		"PATH" => "/cust_incs/categtext1".($APPLICATION->GetCurDir()=='/prodazha_opalubki/'?'2':'').".inc",	// Путь к файлу области
	),
	false
);?>
			...
			<div class="newblock15">
				<a target="_blank" href="https://opalubka.market/tseny-na-opalubku/">ПРАЙС-ЛИСТ ЦЕН НА ОПАЛУБКУ</a>
			</div>
