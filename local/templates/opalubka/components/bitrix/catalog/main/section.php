...
$section = CMaxCache::CIBlockSection_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), CMax::makeSectionFilterInRegion($arSectionFilter), false, array('TIMESTAMP_X', "ID", 'UF_FAQ', "IBLOCK_ID", "NAME", "DESCRIPTION", "PICTURE", "DETAIL_PICTURE", "UF_SHOW_CALC", "UF_SECTION_DESCR", "UF_OFFERS_TYPE", 'UF_FILTER_VIEW', 'UF_LINE_ELEMENT_CNT', 'UF_TABLE_PROPS', 'UF_SECTION_BG_DARK', 'UF_LINKED_BLOG', 'UF_BLOG_BOTTOM', 'UF_BLOG_WIDE', 'UF_BLOG_MOBILE', 'UF_LINKED_BANNERS', 'UF_BANNERS_BOTTOM', 'UF_BANNERS_WIDE','UF_ADDESC','UF_PANEL', 'UF_TOPPIC' ,'UF_TECH','UF_ICO','UF_NOICO','UF_TABS','UF_ADV','UF_AFT','UF_TOPCAT','UF_DOST','UF_ANONS','UF_BANNERS_MOBILE', $arParams["SECTION_DISPLAY_PROPERTY"], $arParams["SECTION_BG"], "IBLOCK_SECTION_ID", "DEPTH_LEVEL", "LEFT_MARGIN", "RIGHT_MARGIN"));
CMax::AddMeta([
...
<div class="main-catalog-wrapper clearfix">
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "front_sale4",
		"TITLE_BLOCK" => "Наши объекты",
		"TITLE_BLOCK_ALL" => "Все объекты",
		"ALL_URL" => "sale/",
...
?>
        ...
        $APPLICATION->IncludeComponent(
			...
			Array(
				...
				"EDIT_TEMPLATE" => "",
				"PATH" => "/cust_incs/test.inc"
			)
		);?>
                <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/reviews_block.php", Array(), Array());?>
                <?$APPLICATION->IncludeFile(SITE_DIR."include/custom/stores_map_block.php", Array(), Array());?>
	</div>
	<?if($bShowLeftBlock):?>
