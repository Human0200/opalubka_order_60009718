						...
						<div class="wrapper_inner">	
							...
							<table>
								<tbody>
									...
									if (isMobile()){
										$background = ($arItem["PROPERTIES"]['TABLET_IMAGE']['VALUE'] ? CFile::GetPath($arItem["PROPERTIES"]['TABLET_IMAGE']['VALUE']) : $background);
									}
													...
													<?if($arItem["PROPERTIES"]["LINK_ITEM"]["VALUE"]):?>
														...
														<div class="banner_title item_info">
															...
															<?if($arItem['PROPERTIES']['TITLE_H1']['VALUE'] == "Y" && !$bShowH1):?>
																<h1 class="head-title 1 js-notice-block__title">
															<?else:?>
																<span class="head-title 1 js-notice-block__title">
															<?endif;?>
													...
													<?if($arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] != "image"):?>
														<?if($arItem["PROPERTIES"]["LINK_ITEM"]["VALUE"]):?>
															...
															<div class="banner_title item_info">
																...
																<?if($arItem['PROPERTIES']['TITLE_H1']['VALUE'] == "Y" && !$bShowH1):?>
																	<h1 class="head-title 3 js-notice-block__title">
																<?else:?>
																	<span class="head-title 3 js-notice-block__title">
																<?endif;?>
														...
														<?else:?>
															...
															<?if($arItem["NAME"]):?>
																<div class="banner_title">
																	<?if($arItem['PROPERTIES']['TITLE_H1']['VALUE'] == "Y" && !$bShowH1):?>
																		<h1 class="head-title 4">
																	<?else:?>
																		<span class="head-title 4">
																	<?endif;?>
