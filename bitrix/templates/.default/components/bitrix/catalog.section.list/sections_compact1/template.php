...
<?if($arResult["SECTIONS"]){?>
	...
	<div class="section-compact-list section-compact-list2">
			...
			?>
				<div class="col-lg-2 col-md-4 col-xs-6 col-xxs-12">
					<div class="section-compact-list__item item bordered box-shadow flexbox flexbox--row" id="<?=$this->GetEditAreaId($arItems['ID']);?>">
						...
						<div>
							<?
							  $rsSect = CIBlockSection::GetList(array(),array('IBLOCK_ID' => 21, 'ID' => $arItems['ID']),false,array('NAME','UF_ADDESC'));
							      while ($ar_Sect = $rsSect->GetNext())
								   {
								   	$desc=$ar_Sect['~UF_ADDESC'];
								   }
							?>
