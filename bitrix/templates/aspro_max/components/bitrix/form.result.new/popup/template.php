                ...
                <script>
                    if (arMaxOptions['THEME']['USE_FORMS_GOALS'] !== 'NONE') {
                        ...
                        if (arMaxOptions['THEME']['USE_FORMS_GOALS'] !== 'COMMON') {
                            eventdata.gloal += '_<?=$arResult['arForm']['ID'];?>';
                        }
        ...
        <div class="form_footer">
            ...
            <?if ($bShowLicenses == 'Y'):?>
                ...
                <div class="licence_block filter onoff label_block">
                    <input type="checkbox" id="licenses_popup" name="licenses_popup" <?=TSolution::GetFrontParametrValue('LICENCE_CHECKED') === 'Y' ? 'checked' : '';?> required value="Y">
