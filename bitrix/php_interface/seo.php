...
function zamena_arenda($iblock,$secid,$text) {
	$ipropSectionValues = new \Bitrix\Iblock\InheritedProperty\SectionValues($iblock, $secid);
	$arSEO = $ipropSectionValues->getValues();
	$h1=$arSEO['SECTION_PAGE_TITLE'];
	
	
	if ($_SERVER['REQUEST_URI']=='/arenda_opalubki/')
	{
		$h1='Аренда опалубки в Москве';
	}
	
	if ($_SERVER['REQUEST_URI']=='/prodazha_opalubki/')
	{
		$h1='Продажа опалубки в Москве';
	}
	
	
	$titlem=mb_strtolower($h1);
	$ourstroka=$text;
	...
	if (strpos($titlem, 'перекрытий') !== false) {
		$text_tip_imenitpadej='опалубка перекрытий';
	...
	if (strpos($titlem, 'опалубки') !== false) {
		$text_tip_imenitpadej='опалубка';
		$text_tip_roditpadej='опалубки';
		$text_tip_datelnyi='опалубке';
		$text_tip_vinitelnyi='опалубку';
		$text_tip_tvoriyelnyi='опалубкой';
		$text_tip_predlojnyi='опалубке';
	}
	...
	if (strpos($titlem, 'опалубки перекрытий') !== false) {	$text_tip_imenitpadej='опалубка перекрытий';
				...
				$text_tip_tvoriyelnyi='опалубкой перекрытий';
				$text_tip_predlojnyi='опалубке перекрытий';}
	if (strpos($titlem, 'опалубки на объемных стойках') !== false) {	$text_tip_imenitpadej='опалубка на объемных стойках';
	...
	if (strpos($titlem, 'опалубки на телескопических стойках') !== false) {	$text_tip_imenitpadej='опалубка на телескопических стойках';
	...
	if (strpos($titlem, 'пространственной опалубки') !== false) {	$text_tip_imenitpadej='пространственная опалубка';
	...
	if (strpos($titlem, 'крупнощитовой опалубки для фундамента') !== false) {	$text_tip_imenitpadej='крупнощитовая опалубка для фундамента';
	...
	if (strpos($titlem, 'мелкощитовой опалубки для фундамента') !== false) {	$text_tip_imenitpadej='мелкощитовая опалубка для фундамента';
	...
	if (strpos($titlem, 'опалубки колонн') !== false) {	$text_tip_imenitpadej='опалубка колонн';
	...
	if (strpos($titlem, 'крупнощитовой опалубки колонн') !== false) {	$text_tip_imenitpadej='крупнощитовая опалубка колонн';
	...
	if (strpos($titlem, 'мелкощитовой опалубки колонн') !== false) {	$text_tip_imenitpadej='мелкощитовая опалубка колонн';
	...
	if (strpos($titlem, 'опалубки для лифтовых шахт') !== false) {	$text_tip_imenitpadej='опалубка для лифтовых шахт';
	...
	if (strpos($titlem, 'телескопических стоек') !== false) {	$text_tip_imenitpadej='телескопические стойки для опалубки';
	...
	if (strpos($titlem, 'балок для опалубки') !== false) {	$text_tip_imenitpadej='балки для опалубки';
	...
	if (strpos($titlem, 'опалубки для забора') !== false) {	$text_tip_imenitpadej='опалубка для забора';
	...
	if (strpos($titlem, 'строительных лесов') !== false) {	$text_tip_imenitpadej='строительные леса';
	...
	if (strpos($titlem, 'инвентарной опалубки') !== false) {	$text_tip_imenitpadej='инвентарная опалубка';
	...
	if (strpos($titlem, 'инвентарной опалубки для фундамента') !== false) {	$text_tip_imenitpadej='инвентарная опалубка для фундамента';
	...
	if (strpos($titlem, 'инвентарной опалубки колонн') !== false) {	$text_tip_imenitpadej='инвентарная опалубка колонн';
	...
	if (strpos($titlem, 'инвентарной опалубки перекрытий') !== false) {	$text_tip_imenitpadej='инвентарная опалубка перекрытий';
	...
	if (strpos($titlem, 'щитовой опалубки') !== false) {	$text_tip_imenitpadej='щитовая опалубка';
	...
	if (strpos($titlem, 'крупнощитовой опалубки') !== false) {	$text_tip_imenitpadej='крупнощитовая опалубка';
	...
	if (strpos($titlem, 'мелкощитовой опалубки') !== false) {	$text_tip_imenitpadej='мелкощитовая опалубка';
	...
	if (strpos($titlem, 'щитовой опалубки для фундамента') !== false) {	$text_tip_imenitpadej='щитовая опалубка для фундамента';
	...
	if (strpos($titlem, 'щитовой опалубки колонн') !== false) {	$text_tip_imenitpadej='щитовая опалубка колонн';
	...
	if (strpos($titlem, 'щитовой опалубки стен') !== false) {	$text_tip_imenitpadej='щитовая опалубка стен';
	...
	if (strpos($titlem, 'легкой опалубки') !== false) {	$text_tip_imenitpadej='легкая опалубка';
	...
	if (strpos($titlem, 'монолитной опалубки') !== false) {	$text_tip_imenitpadej='монолитная опалубка';
	...
	if (strpos($titlem, 'мостовой опалубки') !== false) {	$text_tip_imenitpadej='мостовая опалубка';
	...
	if (strpos($titlem, 'объемной опалубки') !== false) {	$text_tip_imenitpadej='объемная опалубка';
	...
	if (strpos($titlem, 'объемной опалубки перекрытий') !== false) {	$text_tip_imenitpadej='объемная опалубка перекрытий';
	...
	if (strpos($titlem, 'опалубки для ленточного фундамента') !== false) {	$text_tip_imenitpadej='опалубка для ленточного фундамента';
	...
	if (strpos($titlem, 'разборно-переставной опалубки') !== false) {	$text_tip_imenitpadej='разборно-переставная опалубка';
	...
	if (strpos($titlem, 'разборной опалубки') !== false) {	$text_tip_imenitpadej='разборная опалубка';
	...
	if (strpos($titlem, 'стальной опалубки') !== false) {	$text_tip_imenitpadej='стальная опалубка';
	...
	if (strpos($titlem, 'стеновой инвентарной опалубки') !== false) {	$text_tip_imenitpadej='стеновая инвентарная опалубка';
	...
	if (strpos($titlem, 'съемной опалубки') !== false) {	$text_tip_imenitpadej='съемная инвентарная опалубка';
				$text_tip_roditpadej='съемной инвентарной опалубки';
				$text_tip_datelnyi='съемной инвентарной опалубке';
				$text_tip_vinitelnyi='съемную инвентарную опалубку';
				$text_tip_tvoriyelnyi='съемной инвентарной опалубкой';
				$text_tip_predlojnyi='съемной инвентарной опалубке';}
	if (strpos($titlem, 'телескопической опалубки') !== false) {	$text_tip_imenitpadej='телескопическая опалубка';
	...
	if (strpos($titlem, 'универсальной опалубки') !== false) {	$text_tip_imenitpadej='универсальная опалубка';
	...
	if (strpos($titlem, 'опалубки б/у') !== false) {	$text_tip_imenitpadej='опалубка б/у';
	...
	if (strpos($titlem, 'опалубки для фундамента б/у') !== false) {	$text_tip_imenitpadej='опалубка для фундамента б/у';
	...
	if (strpos($titlem, 'опалубки колонн б/у') !== false) {	$text_tip_imenitpadej='опалубка колонн б/у';
	...
	if (strpos($titlem, 'стеновой опалубки б/у') !== false) {	$text_tip_imenitpadej='стеновая опалубка б/у';
...
/*Тип опалубки + аренда*/
	...
	if (strpos($titlem, 'опалубки') !== false) {
		...
		$text_arenda_imenitpadej='опалубка';
		$text_arenda_roditpadej='опалубки';
		$text_arenda_datelnyi='опалубке';
		$text_arenda_vinitelnyi='опалубку';
		$text_arenda_tvoriyelnyi='опалубкой';
		$text_arenda_predlojnyi='опалубке';
	}	
