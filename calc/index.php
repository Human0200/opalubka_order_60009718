...
.rangeslider__handle {
  ...
  background: url(/img/knobr.png) !important;
...
.rangeslider {
    ...
    margin: 10px;
    background: url(/img/calcb.png) transparent !important;
    border-radius: 0 !important;
    box-shadow: none !important;
}

p.width, p.height{padding-left: 40px;font-family: Ubuntu; font-size: 18px; font-weight: bold;}
p.width {background: url(/img/w.png) no-repeat transparent !important;}
p.height {background: url(/img/h.png) 15px 0 no-repeat transparent !important;}
...
.outwrapper{display: flex;   flex-wrap:wrap; padding: 15px;margin-bottom: 50px;}
.wrapper{margin-right: 15px; }
.wrapper p{margin: 0;}
.inwrapper{padding: 1px; margin: 3px;}
.outwrapper table{background-color: #fff;    width: 800px;    margin-top: 50px;   padding: 5px;}
.outwrapper table th{font-weight: bold;padding: 5px; border: 1px solid; text-align: center;}
.outwrapper table td{border: 1px solid;padding: 5px;}
.outwrapper button{
...
#l,#h{font-weight: bold;}

 @media screen and (max-width: 480px) {
.outwrapper{display:block;}
.rangeslider {
    display: inline-block !important;
    width: 290px !important;
 	}
 	.outwrapper table{width: auto !important;}
}
.middle-span {
    position: absolute;
    bottom: 4px;
...
<div class="outwrapper">
	...
	<div class="wrapper">
		...
		<div class="inwrapper">
			 1 <input class="r2" type="range" min="10" max="30" id="r2"><span class="middle-span">2</span>3
		</div>
	</div>
	<table>
	<tbody>
...
<h2> <br>
   <br>
   Калькулятор опалубки перекрытий</h2>
<div class="outwrapper calc3">
 ...
 <input type="text" id="vys" value="1" name="">
	</div>-->
	<div class="wrapper">
		<p>
 ...
 <!--  <p>Площадь: <span id="res"></span></p>
    <p>Итог: <span id="res2"></span></p>--> <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js'></script> <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/rangeslider.js/2.3.0/rangeslider.min.js"></script> <script type="text/javascript">
...
$( ".calc3 input, .calc3 select" ).change(function() {calc3()})
$( ".calc3 input" ).keyup(function() {calc3()})
...
<p style="text-align: left;">
 <span class="callback-block" data-event="jqm" data-param-form_id="CALLBACK" data-name="callback"> <img src="/cta2.png" class="cta2img"> <!-- Добавлен класс cta2img --> </span>
</p>
 <style type="text/css">
